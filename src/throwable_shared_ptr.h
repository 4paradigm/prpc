#ifndef PARADIGM4_PICO_COMMON_THROWABLE_SHARED_PTR_H
#define PARADIGM4_PICO_COMMON_THROWABLE_SHARED_PTR_H
...
#endif // PARADIGM4_PICO_COMMON_THROWABLE_SHARED_PTR_H
